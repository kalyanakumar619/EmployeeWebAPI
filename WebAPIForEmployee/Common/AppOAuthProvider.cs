...
namespace WebAPIForEmployee.Common
{
    public class AppOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        /// </summary>  
        private EmployeeMasterEntities databaseManager = new EmployeeMasterEntities();
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            var user = this.databaseManager.SP_AuthLogin(usernameVal, passwordVal).ToList();
